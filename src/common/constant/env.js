...
export let REACT_APP_ECO_BASE_URL = "";
if (window.location.hostname.includes("localhost")) {
    // REACT_APP_ECO_BASE_URL = "https://dev-eg-eco.livc.in";
    // REACT_APP_ECO_BASE_URL = "https://qa-eg-eco.livc.in";
    REACT_APP_ECO_BASE_URL = "https://uat-lc.livc.in";
} else if (window.location.hostname.includes("dev"))  {
    // REACT_APP_ECO_BASE_URL = "https://dev-eg-eco.livc.in";
    REACT_APP_ECO_BASE_URL = "https://qa-eg-eco.livc.in";
} else if (window.location.hostname.includes("qa-lc"))  {
    ...
    // REACT_APP_ECO_BASE_URL = "https://prod-eg-eco.livc.in";
    REACT_APP_ECO_BASE_URL = "https://qa-eg-eco.livc.in";
